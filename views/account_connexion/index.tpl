...
<div class="error" id="error">
    ...
    <div class="error__close" id="error__close"><svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 20 20"
            height="20">
            <path fill="#393a37"
    ...
    <p class="inscription">Je n'ai pas de <span>compte</span>. Je m'en <span> <a class="deco_cree"
                href="account_creation"> crée</a> </span> un.</p>
    <div align="center">
